...
| 母題 chip 排序統一（三組陣列一致，國內→國外→酬勞→支出憑證→採購→餐費→教育訓練→國科會→教育部→成大） | 2026-05-07e |
| 情境卡去重（change-transport deprecated、senior-premium/discount-ticket 降格子情境） | 2026-05-07e |
| 教育訓練情境卡擴充（+3：公費進修假/外部機構費/線上課程） | 2026-05-07e |
| 採購情境卡擴充（+2：軟體授權/訂閱採購、勞務 vs 財物分界） | 2026-05-07e |
| abroad ↔ voucher / lecture ↔ procurement / domestic ↔ education cross_ref 鏈結 | 2026-05-07e |
...
- **WIP 母題情境建設**：餐費及其他支出（節點 5，待情境）；採購及履約（7 情境卡，待補 A/C/D 類條文）；教育訓練（5 情境卡，待補 A/C/D 類條文；訓練假/線上課程卡已建）
